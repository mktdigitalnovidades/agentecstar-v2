        ...
        <div class="container">
            ...
            <div style="display: grid; gap: 2rem; margin-top: 3rem;">
                ...
                <div style="text-align: center; color: white;">
                    <p>Adicione aqui o conteúdo dos seus serviços através do painel administrativo do WordPress.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="benefits" class="section">
        <div class="container">
            <div class="section-header">
                ...
                <p class="section-subtitle">Vantagens de automatizar seu atendimento com nossa IA</p>
            </div>
        </div>
    </section>
    ...
    <section id="how-it-works" class="section">
        <div class="container">
            <div class="section-header">
                ...
                <p class="section-subtitle">Processo simples para implementar automação em seu negócio</p>
            </div>
        </div>
    </section>
    ...
    <section id="testimonials" class="section">
        <div class="container">
            <div class="section-header">
                ...
                <p class="section-subtitle">O que nossos clientes dizem sobre nossa automação</p>
            </div>
        </div>
    </section>
    ...
    <section id="faq" class="section">
        <div class="container">
            <div class="section-header">
                ...
                <p class="section-subtitle">Tire suas dúvidas sobre automação com IA</p>
            </div>
        </div>
    </section>
